                            ...
                            <div class="panel-heading">Ubah Data Pasien </div>
                                ...
                                <div class="row">
                                    ...
                                    <form method="post" action="proses_pasien.php">
                                        ...
                                        <input  type="number" name="no_identitas" id="no_identitas" class="form-control" value="<?=$data['no_identitas']?>"required />
                                        <br />
                                        ...
                                        <input type="submit" name="edit_pasien" value="Simpan" class="btn btn-success" />
